...
2. 분량 (절대 엄수): 대본의 내용은 **최소 8문장 이상**으로 구성하여 2~3줄로 내용이 허무하게 끝나는 것을 철저히 차단하라. 기승전결과 감정선이 충분히 드러나도록 텍스트 분량을 풍성하게 확보해야 한다.
3. 줄바꿈 (호흡 분리): 작성한 대사를 성우가 읽기 편하도록 끊어 읽는 호흡(반 문장 또는 한 문장) 단위마다 반드시 줄바꿈(엔터)을 하라. 결과적으로 **최소 8줄에서 최대 15줄 사이**의 시각적인 줄바꿈이 발생해야 한다. 절대 하나의 거대한 문단으로 뭉쳐 쓰지 마라.
